...
export const TotalPriceArea: FC<TotalPriceInfoAreaProps> = (props) => {
    ...
    const buildCouponCodeDiscountArea = useCallback(
        (): ReactNode => {
            if(controller.checkout.couponCode === "")
                return <></>;
            ...
            return (
                <div className={classNames(styles.detail_container, styles.coupon_discount_detail_container)}>
                    <div className={styles.left_area}>
                        ...
                        <p className={styles.coupon_code}>{controller.checkout.couponCode}</p>
                    </div>
            ...
            <Accordion isExpanded={isSubDetailsAreaOpened}>
                ...
                <Content>
                    <div className={styles.detail_container}>
                        ...
                        <p>Rs {controller.checkout.cart.price}</p>
                    </div>
                    ...
                    <div className={styles.detail_container}>
                        ...
                        <p>
                            <span style={{textDecoration: (controller.checkout.hasAboveHundredDiscount()) ? "line-through" : "revert"}}>
                                Rs. {props.details.shippingCost}
                            </span> 
                            &nbsp;<span style={{display: (controller.checkout.hasAboveHundredDiscount()) ? "revert" : "none"}}>Rs. 0</span>
                        </p>
                    </div>
                </Content>
            </Accordion>            
