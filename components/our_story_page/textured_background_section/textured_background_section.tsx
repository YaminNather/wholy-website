...
export const TexturedBackgroundSection: FC = (props) => {
    return (
        <section className={styles.textured_background_section}>
            ...
            <Image src={UIProducts.strawberry.fruits[0]} alt="" className={classNames("background_prop", styles.fruit, styles.left_strawberry)} />
            
            {/* <Image src={UIProducts.pineapple.fruits[1]} alt="" className={classNames("background_prop", styles.fruit, styles.left_pineapple)} /> */}
            ...
            <div className={classNames("container", styles.container)}>
                ...
                <p>
                    ...
                    made to help you <span className={classNames("personalized_text", styles.personalized_text)}>take a moment for yourself and eat mindfully</span>. We are on
